...
const FoodDetails=()=>
{
    ...
    useEffect(()=>
    {
        ...
        {
            const res= await fetch(`http://localhost:5000/product/find/${id}`,{headers:{
    ...
    return (
        <div className={classes.container}>
            ...
            <img src={`http://localhost:5000/images/${foodDetails?.img}`} alt="image"/>
            </div>
            ...
            <div className={classes.right}>
                ...
                <button className={classes.addToCart} onClick={addToCart}>Add to Cart <AiOutlineShoppingCart/></button>
            </div>
            </div>
        </div>
    )
